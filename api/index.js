...
app.get("/", (req, res) => res.send("<style>html { width: 100%; height: 100%; } body { background-color: rgb(43, 43, 43); font-family: sans-serif; }</style><a href=\"/api/dayoff\" style=\"color: white\">https://twdayoff-api.vercel.app/api/dayoff</a>"));

app.get('/api/dayoff', async (req, res) => {
